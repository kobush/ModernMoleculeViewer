...
namespace ModernMoleculeViewer.Model
{
    ...
    internal abstract class Atom : HoverObject
    {
        ...
        internal static Atom CreateAtom(Molecule molecule, string pdbLine)
        {
            ...
            float x = float.Parse(pdbLine.Substring(30, 8), CultureInfo.InvariantCulture);
            float y = float.Parse(pdbLine.Substring(38, 8), CultureInfo.InvariantCulture);
            float z = float.Parse(pdbLine.Substring(46, 8), CultureInfo.InvariantCulture);
