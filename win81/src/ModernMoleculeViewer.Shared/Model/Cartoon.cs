...
namespace ModernMoleculeViewer.Model
{
    ...
    internal class Cartoon 
    {
        ...
        private readonly GeometricPrimitive _mesh;
        ...
        internal Cartoon(Residue residue, Color initialColor, GraphicsDevice graphicsDevice)
        {
            ...
            _residue.Ribbon.GetResidueSpline(_residue, out _ribbonPoints,
                out _torsionVectors, out _normalVectors);
            ...
            if (_vertices.Count > 0 && _indices.Count > 0)
                _mesh = new GeometricPrimitive(graphicsDevice, _vertices.ToArray(), _indices.ToArray());
        }

        public GeometricPrimitive Mesh
        {
            get { return _mesh; }
        }
